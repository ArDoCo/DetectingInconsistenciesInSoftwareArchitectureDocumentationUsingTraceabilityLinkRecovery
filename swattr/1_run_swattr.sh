...
java -jar ardoco-core-pipeline.jar -c config.txt -n Mediastore -m owl/mediastore.repository.owl -t ../benchmark/mediastore/text_2011/mediastore_2011.txt -o ../results/swattr-raw/mediastore-historic
